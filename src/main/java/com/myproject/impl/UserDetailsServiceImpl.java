...
public class UserDetailsServiceImpl implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		UserDetailsDto dto = new UserDetailsDto(user.getEmail(), user.getPassword(), authorities,user.getId(), user.getName(),user.getAvatar(), user.getPhone(), user.getAddress(), user.getEmail(), user.getCode());
		return dto;
	}
